...
static uint32_t sctp_crc32_sb8_64_bit(uint32_t crc, unsigned char const *p_buf,
...
static uint32_t sctp_crc32_sb8_64_bit_zero(uint32_t crc, uint32_t length, uint32_t offset)
{
  uint32_t li;
  uint32_t term1, term2;
  uint32_t running_length;
...
static uint32_t update_crc32(uint32_t crc32c, unsigned char const *buffer, unsigned int length)
{
  ...
  if (buffer)
    return (sctp_crc32_sb8_64_bit(crc32c, buffer, length, offset));
  else
    return (sctp_crc32_sb8_64_bit_zero(crc32c, length, offset));
}
...
uint32_t crc32_sctp(uint32_t crc, unsigned char const *data, unsigned length)
{
